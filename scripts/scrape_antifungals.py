...
# -*- coding: utf-8 -*-
"""
scrape_antifungals.py - antibiotic-books.jp 抗真菌薬セクション (1001-1010) をスクレイプ

使い方:
  PYTHONUTF8=1 python scripts/scrape_antifungals.py

出力:
  data/raw/antifungal_books_raw.json
"""
...
OUTPUT_PATH = REPO_ROOT / "data" / "raw" / "antifungal_books_raw.json"

AF_IDS = list(range(1001, 1011))  # 1001〜1010
...
async def scrape_all():
    ...
    async with async_playwright() as p:
        ...
        print(f"\n抗真菌薬 ({AF_IDS[0]}〜{AF_IDS[-1]}) をスキャン中...\n")

        for drug_id in AF_IDS:
    ...
    print("次のステップ: PYTHONUTF8=1 python scripts/extract_antifungals.py")
